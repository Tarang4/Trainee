                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(
                            right: 10.0, left: 10, top: 3, bottom: 8),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Container(
                      ...
                      Padding(
                        ...
                        child: Container( width: 300,alignment: Alignment.topLeft,
                          child: RichText(
                            ...
                            text: new TextSpan(
                              ...
                              children: <TextSpan>[
                                new TextSpan(text: 'Liked by ',style: TextStyle(fontSize: 12)),
                                new TextSpan(
                                    text: modalPost.username??"" ,
                                    style:
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Container(width: 300,child: Container( width: 300,alignment: Alignment.topLeft,
                                ...
                                text: new TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    new TextSpan(
                                        ...
                                        style:
                                        new TextStyle(fontWeight: FontWeight.bold,fontSize: 13)),
                                    new TextSpan( text: modalPost.comment??"",style: TextStyle(fontSize: 12)),

                                  ],
                                ),
                              ),
                            ),),
                            Text(" more",style: TextStyle(fontSize: 13.5,color: Colors.black.withOpacity(0.5)))
                          ],
                        ),
                      ),
                      // Padding(
                      //   padding: const EdgeInsets.only(top: 15.0),
                      //   child: Text(" more",style: TextStyle(fontSize: 13.5,color: Colors.black.withOpacity(0.5))),
                      // )
